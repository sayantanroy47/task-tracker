...
class ChatTestExamples {
  static const List<Map<String, dynamic>> testMessages = [
    ...
    {
      'message':
          'URGENT: Submit tax documents by tomorrow noon, also remember to pick up dry cleaning and schedule dentist appointment next week',
      'expectedTasks': [
        {
    ...
    {'message': 'What time is the meeting tomorrow?', 'expectedTasks': []},
  ];
  ...
  static List<Map<String, dynamic>> getTimeReferenceExamples() {
    return testMessages.where((example) {
      ...
      return tasks
          .any((task) => task['hasTime'] == true || task['hasDate'] == true);
    }).toList();
  }
...
class ConfidenceTestCases {
  static const List<Map<String, dynamic>> confidenceTests = [
    ...
    {
      'message': 'Call doctor to schedule appointment',
...
class CategoryTestCases {
  static const List<Map<String, dynamic>> categoryTests = [
    // Household
    {
      'message': 'Buy groceries and clean the house',
